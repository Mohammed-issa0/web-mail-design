      ...
      <div className="flex-1 flex overflow-hidden pb-16 md:pb-0">
        ...
        {!showSettings && (
          <>
            ...
            <AnimatePresence>
              {rightSidebarView === "calendar" && <CalendarPanel onClose={handlePanelClose} />}

              {rightSidebarView === "tasks" && <TasksPanel onClose={handlePanelClose} />}

              {rightSidebarView === "contacts" && <ContactsPanel onClose={handlePanelClose} />}
            </AnimatePresence>
          </>
        )}
      </div>
